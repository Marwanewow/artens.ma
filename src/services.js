  ...
  return (
    <>
      ...
      >
        <div className="ic">
          <img
            src={data?.images?.find((img) => img.name === "icon1")?.src}
            alt="icon1"
            width="250px"
          />
        ...
        <div className="ic">
          <img
            src={data?.images?.find((img) => img.name === "icon2")?.src}
            alt="icon2"
            width="100px"
          />
          <h3>Media Promotion</h3>
          <p>
            Planification et stratégies pour promouvoir vos productions sur le
            web.
          </p>
        </div>
        ...
        <div className="ic">
          <img
            src={data?.images?.find((img) => img.name === "icon3")?.src}
            alt="icon3"
            width="100px"
          />
